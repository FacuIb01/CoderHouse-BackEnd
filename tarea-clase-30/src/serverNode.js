...
const {routerRandom, routerInfo} = require("./routes/routes")
const {args} = require("./utils/info")
...
if(args.server === "cluster"){ //se inicia el servidor como cluster si lo indicamos por parametro
